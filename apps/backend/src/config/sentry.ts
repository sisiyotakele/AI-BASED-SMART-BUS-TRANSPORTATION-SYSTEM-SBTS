...
export function initializeSentry() {
    // Check if Sentry is enabled and DSN is provided
    if (!env.SENTRY_ENABLED) {
        logger.info('Sentry error monitoring is disabled (SENTRY_ENABLED=false)');
        return;
    }
 ...
 */
export const sentryRequestHandler: any = Sentry.Handlers.requestHandler({
 ...
 */
export const sentryTracingHandler: any = Sentry.Handlers.tracingHandler();
